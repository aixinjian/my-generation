...
public class ControllerGenerator {
	...
	public String generate(DatabaseTableInfo dbTableInfo) throws SQLException {
		...
		data.append("@RestController\r\n")
				...
				.append("\tResponseEntity<" + dbTableInfo.getVo().getClassName() + "> query(@ApiParam(value = \"" + primaryKey.getComment() + "\")@RequestParam(required = true)" + primaryKey.getClazz() + " " + primaryKey.getName() + ") throws " + Config.exceptionName + " {\r\n")
		...
		data.append("\t\t" + serviceName + ".update(po);\r\n")
				...
				.append("\tpublic @ResponseBody\r\n")
				.append("\tResponseEntity delete(@ApiParam(value = \"" + primaryKey.getComment() + "\")@RequestParam(required = true)" + primaryKey.getClazz() + " " + primaryKey.getName() + ") throws " + Config.exceptionName + " {\r\n")
